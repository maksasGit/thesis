...
\bibitem{SearchClustering}
Clustering in Information Retrieval, \emph{https://nlp.stanford.edu/IR-book/html/htmledition/clustering-in-information-retrieval-1.html}

\bibitem{UserClustering}
Trip Database Blog, \emph{Clustering Search Results Using Carrot2}, \emph{https://blog.tripdatabase.com/2024/04/28/clustering-search-results-using-carrot2/}
