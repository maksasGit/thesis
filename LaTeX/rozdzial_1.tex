...
\section{Klasterzyacja}
	...
	\subsection{Metody klasteryzacji}
		...
		\begin{enumerate}
			...
			\item Algorytmy oparte na gęstości danych:\\
				...
				\textbf{K-średnich (K-means)} -- iteracyjny algorytm oparty na minimalizacji sumy kwadratowych odchyleń punktów klastrów od ich centrów.\\
				
				\textbf{Rozpowszechnianie podobieństwa (Affinity Propagation)} -- algorytm, który rozprzestrzenia wiadomości o podobieństwie między parami obiektów w celu wyboru typowych przedstawicieli każdego klastra.\\
				
				\textbf{Przesunięcie średniej (mean shift)} -- metoda wybierająca centroidy klastrów w obszarach o największej gęstości.\\
				
				\textbf{Klasteryzacja spektralna (spectral clustering}) -- metoda wykorzystująca wartości własne macierzy odległości do zmniejszenia wymiarowości przed zastosowaniem innych metod klasteryzacji.\\
				
				\textbf{DBSCAN (Density-Based Spatial Clustering of Applications with Noise)} -- algorytm grupujący punkty w jeden klaster w obszarach o wysokiej gęstości i oznaczający odosobnione punkty jako szum.
		\end{enumerate}
	...
	\subsection{Zastosowanie}
		...
		\textbf{Klasteryzacja wyników wyszukiwania} polega na grupowaniu dokumentów zwróconych w odpowiedzi na zapytanie użytkownika, aby podobne dokumenty pojawiały się razem.\\
		
		\textbf{Grupowanie użytkowników o podobnych zainteresowaniach} pozwala na lepszą personalizację treści, rekomendacje oraz targetowanie w reklamie.\\
		
		\textbf{Grupowanie tekstowych dokumentów}, takich jak artykuły prasowe, publikacje naukowe czy wiadomości w mediach społecznościowych, polega na organizowaniu ich według tematyki, co ułatwia użytkownikom odnalezienie interesujących ich treści.
